...
def main():
    ...
    mod = hres/60
    posx, posy, rot = 0,0,0
    floor = pg.surfarray.array3d(pg.image.load('images/floor.jpg'))
    kart = pg.surfarray.array3d(pg.image.load('images/marioKart.png'))
    sky = pg.image.load('images/skybox.jpg')
